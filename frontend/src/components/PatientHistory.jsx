...
import { Search, Eye, Users, ChevronLeft, ChevronRight, X, Calendar, MapPin, User, FileText } from "lucide-react";
...
export default function PatientHistory() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                View and manage registered hospital patients
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Controls Section: Search & Section Title */}
          ...
          <table className="w-full text-left border-collapse min-w-[650px]">
            <thead>
              <tr className="bg-gradient-to-r from-blue-700 to-blue-600 text-white text-xs font-bold uppercase tracking-wider">
                ...
                <th className="px-6 py-4 border-b border-blue-800/40">Gender</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-semibold shadow-sm hover:shadow hover:scale-105 active:scale-95 transition-all duration-150"
                      >
          ...
          >
            ...
            <div className="space-y-3.5 text-sm">
              ...
              <div className="grid grid-cols-3 gap-2 p-3 rounded-xl bg-gray-50/70 border border-gray-100">
                ...
                <span className="col-span-2 capitalize font-medium text-gray-900">{selectedPatient.gender || "N/A"}</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 p-3 rounded-xl bg-gray-50/70 border border-gray-100">
                ...
                <span className="col-span-2 font-medium text-gray-900">{selectedPatient.dob || selectedPatient.dateOfBirth || "N/A"}</span>
              </div>
            ...
            <div className="pt-2 flex justify-end">
              <button
                onClick={() => setSelectedPatient(null)}
                className="px-6 py-2.5 bg-gray-900 hover:bg-gray-800 text-white font-medium rounded-xl text-sm transition-all shadow-md active:scale-95"
              >
                Close
              </button>
            </div>
